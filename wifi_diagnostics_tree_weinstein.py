...
Pseudocode:
1. Set answer vairable equal to no, to use with while loop.
...
# Count to be iterated by one to use for indexing
count = 0

# While loop will loop through diagnosis list until a soluion is found or we come to final solution.
